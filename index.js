  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: '订单详情',roles:'user',hide:true,requireAuth: true },
      }
    ]
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta:{title:"单间上传",roles:'user',hide:false,requireAuth: true},
      },
      {
        path: '/hotelSubmit',
        name:'单间确认',
        ...
        meta:{title:"单间确认",roles:'user',hide:false,requireAuth: true},
      },
      {
        ...
        meta:{title:"套件上传",roles:'user',hide:false,requireAuth: true},
      },
      {
        ...
        meta:{title:"套件确认",roles:'user',hide:false,requireAuth: true},
      }
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta:{title:"房源详情",roles:'user',hide:false,requireAuth: true},
      }
