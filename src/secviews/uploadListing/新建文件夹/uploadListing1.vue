<template>
    <div style="width: 100%; margin: 0 auto; position: relative; left: 9%">
           ...
           <el-row :gutter="10">
              <el-col :span="11">
               <el-form-item label="民宿名称" prop="name">
                    <el-input  v-model="ruleForm.name" style="width: 70%" @change="changeNameEvent()"></el-input>
                </el-form-item >
                 <br />
                <el-form-item label="民宿地址" prop="region">
                  <el-input v-model="ruleForm.region" style="width: 70%" @change="changeRegionEvent()"></el-input>
                </el-form-item>
                <br />
               ...
               <el-col :span="11">
                ...
                <el-form-item label="设施情况" prop="equipment" >
                  <el-radio-group v-model="ruleForm.equipment" @change="changeEquipment()">
                ...
                <el-form-item label="周边情况" prop="surrounding" >
                  <el-radio-group v-model="ruleForm.surrounding" @change="changeSurrounding()">
              ...
              >
                ...
                <br />
                <el-button type="primarySigle" @click="submitForm('ruleForm', 'hotelSingleAppl')"
                >创建单间</el-button
                >
                <el-button type="primaryMulti" @click="submitForm('ruleForm', 'hotelMultiApply')"
                >创建套间</el-button
                >
              </el-col>
           </el-row>
